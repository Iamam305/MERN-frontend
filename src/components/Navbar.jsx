      ...
      <div className="px-4 py-4 mx-auto sm:max-w-xl md:max-w-full  lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="relative flex items-center justify-between">
          ...
          >
            <img
              src={
                "https://i.ibb.co/WtBbdvh/tinywow-Untitled-design-removebg-preview-5328065.png"
              }
              alt=""
              className="w-10  h-full"
              
            />
            <span className="ml-2 text-xl font-bold tracking-wide text-indigo-700 uppercase">
            Parchy
            </span>
          </a>
          <ul className=" items-center  space-x-8 hidden lg:flex">
            <li>
              <a
                ...
                title="Our product"
                className="font-medium tracking-wide text-gray-900 transition-colors duration-200 hover:text-indigo-400"
              >
                Product
              </a>
            </li>
